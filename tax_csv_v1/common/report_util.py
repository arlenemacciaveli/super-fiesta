...
def run_exports(app, exporter, format):
    ...
    for cur_format in formats_list:
        # Write one csv
        csvpath = "{}/{}.{}.{}.csv".format(REPORTS_DIR, app.ticker, app.wallet_address, cur_format)
        if cur_format == FORMAT_DEFAULT:
            exporter.export_default_csv(csvpath)
            # Write balance-after-each-transaction csv
            csvpath2 = "{}/{}.{}.{}.csv".format(REPORTS_DIR, app.ticker, app.wallet_address, "balances")
            ...
            xlsxpath = "{}/{}.{}.{}.xlsx".format(REPORTS_DIR, app.ticker, app.wallet_address, cur_format)
